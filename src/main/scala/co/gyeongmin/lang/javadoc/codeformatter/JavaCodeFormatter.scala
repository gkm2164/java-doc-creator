...
object JavaCodeFormatter {
  ...
  def printCodeBlock(codeName: String, tokens: Vector[JavaSToken], debugOption: DebugOption)(implicit log: Logger): Either[ParseError, String] =
    printCodeCommon(codeName, tokens, JavaParser.blockStmt, debugOption)

  def printCode(codeName: String, tokens: Vector[JavaSToken], debugOption: DebugOption)(implicit log: Logger): Either[ParseError, String] =
  ...
  private def printCodeCommon[A](codeName: String,
                                 ...
                                 debugOption: DebugOption)(implicit log: Logger): Either[ParseError, String] = {
  ...
  case class ErrorMessage(shortMessage: String, longMessage: String) extends ParseError

  case object EmptyError extends ParseError {
    override val shortMessage: String = "there's nothing to do with this function"

...
import com.kakao.bengo.scala.functional.Monoid
import com.kakao.bengo.scala.godoc.doc.elements.Argument
...
object BuilderGroup {
  import com.kakao.bengo.scala.functional.MonoidSyntax._

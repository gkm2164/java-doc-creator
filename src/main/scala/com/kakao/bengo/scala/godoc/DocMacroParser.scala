package com.kakao.bengo.scala.godoc

import com.kakao.bengo.godoc.golang.syntax.{GoFunctionDef, GoParser, GoSomeDef, GoTypeDef}
import com.kakao.bengo.scala.godoc.doc.elements.{ArgList, Text, TypeRequired}
